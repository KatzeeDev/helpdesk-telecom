<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" >
            <img class="hidden-md-down" src="../../public/telecom.png" height=40 >
            <img class="hidden-lg-up" src="../../public/telecom.png" height=20 >
        </a>
        ...
        <div class="site-header-content">
            <div class="site-header-content-in">
                ...
                <input type="hidden" id="user_idx" value="<?php echo $_SESSION["usu_id"] ?>">       <!-- ID del Usuario. La guardaremos para ocuparla a nivel global -->
