...
// Listar detalles del ticket al verloo
function listardetalle(tick_id){
    ...
    $.post("../../controller/ticket.php?op=mostrar", { tick_id : tick_id }, function (data) {
        ...
        // TEST console.log( data.tick_estado_texto);

        // Si es estado del ticket esta cerrado, oculta la seccion para agregar respuesta
