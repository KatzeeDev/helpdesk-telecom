    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                // Estructura de Decision para saber el Rol

                if ($row["rol_id"]=="1"){
                    $sub_array[] = '<span class="label label-pill label-success">Ejecutivo</span>';
                }else{
                    $sub_array[] = '<span class="label label-pill label-info">Tecnico de Area</span>';
                }
