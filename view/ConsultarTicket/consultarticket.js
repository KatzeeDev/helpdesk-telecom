// Creamos variables para utilizarlas denuevo
var tabla;
...
$(document).ready(function(){
    ...
    if (rol_id==1){
        tabla=$('#ticket_data').dataTable({
            ...
            lengthChange: false,
            colReorder: true,
            // Para ordenar el datatable segun los ultimos tickets añadidos
            order: [[ 0, 'desc']],
            buttons: [		          
                    'copyHtml5',
                    'excelHtml5',
...
function ver(tick_id){
    window.open('http://localhost:80/HelpDesk/view/DetalleTicket/?ID='+ tick_id +'');
}
